...
class Section
  ...
  module GeneratedAssociationMethods
    sig { params(args: T.untyped, blk: T.untyped).returns(::Step) }
    def build_step(*args, &blk); end

    sig { params(args: T.untyped, blk: T.untyped).returns(::Step) }
    def create_step(*args, &blk); end
    ...
    sig { params(value: T.nilable(::Step)).void }
    def step=(value); end
  end
  ...
  module GeneratedAttributeMethods
    ...
    def saved_change_to_step_id; end
    ...
    sig { returns(T.nilable(::Integer)) }
    def step_id_before_last_save; end

    sig { returns(T.untyped) }
    def step_id_before_type_cast; end

    sig { returns(T::Boolean) }
    def step_id_came_from_user?; end

    sig { returns(T.nilable([::Integer, ::Integer])) }
    def step_id_change; end

    sig { returns(T.nilable([::Integer, ::Integer])) }
    def step_id_change_to_be_saved; end

    sig { params(from: ::Integer, to: ::Integer).returns(T::Boolean) }
    def step_id_changed?(from: T.unsafe(nil), to: T.unsafe(nil)); end

    sig { returns(T.nilable(::Integer)) }
    def step_id_in_database; end

    sig { returns(T.nilable([::Integer, ::Integer])) }
    def step_id_previous_change; end

    sig { params(from: ::Integer, to: ::Integer).returns(T::Boolean) }
    def step_id_previously_changed?(from: T.unsafe(nil), to: T.unsafe(nil)); end

    sig { returns(T.nilable(::Integer)) }
    def step_id_previously_was; end

    sig { returns(T.nilable(::Integer)) }
    def step_id_was; end

    sig { void }
    def step_id_will_change!; end
    ...
    sig { returns(T::Boolean) }
    def will_save_change_to_step_id?; end
